    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-primary">
                <div class="container-fluid">
                    <a class="navbar-brand" href="{{ route('dashboard') }}">
                        <h3 style="color:white;">{{ Auth::User()->company_name }}</h3>
                    </a>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a style="color: white" class="nav-link"
                                    href="{{ route('tasks.index') }}">{{ __('My Tasks') }}</a>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    <li><a class="dropdown-item"
                                            href="{{ asset('/locale/ar') }}">{{ __('Ar') }}</a></li>
                                    <li><a class="dropdown-item"
                                            href="{{ asset('/locale/en') }}">{{ __('En') }}</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer text-center">
                ...
                <a href="https://www.almounkez.com">WrapPixel</a>.
            </footer>
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.btn_add', function() {
                ...
                let numberIncr = trCount > 0 ? parseInt($('#employee').find('tr.cloning_row:last').attr(
                    'id')) + 1 : 0;
                $('#employee').find('tbody').append($('' +
                    ...
                    '<td><input class="input"type="text" name="name[' + numberIncr +
                    ']" class=" form-control"></td>' +
                    '<td><input class="input"type="email" name="email[' + numberIncr +
                    ']" class=" form-control"></td>' +
                    '<td><input class="input"type="password" name="password[' + numberIncr +
                    ']" class="form-control"></td>' +
                    '</tr>'));
            });
